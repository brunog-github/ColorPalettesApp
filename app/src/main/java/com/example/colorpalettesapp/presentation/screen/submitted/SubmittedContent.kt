...
fun SubmitView(onSubmitClicked: () -> Unit) {
    Column(
        ...
        Image(
            ...
            painter = painterResource(id = R.drawable.colorpalette),
            contentDescription = "Color Palette Image"
        )
        Spacer(modifier = Modifier.height(20.dp))
        Text(
            text = stringResource(id = R.string.submit_palette),
            fontWeight = FontWeight.Bold,
            fontSize = MaterialTheme.typography.h5.fontSize
        )
        Spacer(modifier = Modifier.height(4.dp))
        Text(
            text = stringResource(id = R.string.submit_description),
